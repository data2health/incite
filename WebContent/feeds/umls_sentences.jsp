...
<sql:query var="sentences" dataSource="jdbc/AcknowledgementsTagLib">
	...
	from ( select distinct sentence.id,${param.entity},regexp_replace(sentence,${param.entity},E'<b>\\&</b>','ig') as sentence,url,title
			from extraction.sentence, extraction.${param.entity}, extraction.${param.entity}_match, extraction.${param.entity}_mention, jsoup.document 
			...
			and ${param.entity}.id=${param.entity}_match.id and ${param.entity}_match.umls_id=?
		  ) as done;
	<sql:param>${param.cui}</sql:param>
</sql:query>
{
    "headers": [
